 ...
 * action: index
 * method: GEt
 * Route: /usersId/applications
 * Decription: Show all application for given user
 */
...
router.get('/', async (req, res) => {
   ...
   * Action: New
   * Method: Get
   * Route: /users/:usersId/applications/new
   * Description: Show for for creating new application
   */
...
router.get('/:applicationId', (req, res) => {
   ...
   * decription: create anew applaicstion for a new user
   */
